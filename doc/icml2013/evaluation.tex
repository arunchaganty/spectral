...
Using canonical settings, on the various datasets: \tableref{tbl:parameter-recovery}.

Plot: the histogram over errors (for EM?) \todo{Some plots I have doesn't really show much}.
