...
exist; for example, in \reffig{factorialModels}(a), neither $h_1$ nor $h_2$ is
a bottleneck.
...
For example, example (\reffig{factorialModels}(b)),
...
It turns out that this is LP is rank deficient for two reasons,
