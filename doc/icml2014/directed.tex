...
\begin{property}[Faithful representation]
  \label{prop:ci}  
  ...
  such that there is an active trail\footnote{See \todo{cite textbook} for a definition.} between $a$ and $b$ conditioned on $c$,
