...
\begin{algorithm}
  ...
  \begin{algorithmic}
    \REQUIRE A hidden clique $\sC$ with exclusive views (\propertyref{exclusive-views}).
...
%  }
  ...
  \subfigure[Non-example: a noisy-or network] {
...
\figureref{examples-noisy-or} presents one example in this class.
