...
then we can recover the marginal distribution $\Pr(\bh_S)$ up to relabeling of the hidden variables.\footnote{The relabeling for each hidden variables is determined by the permutation in $\TensorFactorize$.}
