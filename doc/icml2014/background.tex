...
For a directed model,
  ...
  %(for directed models, these are $\sG = \{ \Pa(a) \union \{a\} : a \in X \union H \}$).
...
% PL: log-linear parametrization - can't say this for each clique: this is a global notion.
...
% PL: this isn't great notation; reader can figure it out
%&= \sum_{\bi = \ones}^{\vec d}
  &= \sum_{\bi}
