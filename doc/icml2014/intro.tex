...
and have been employed across many fields [TODO: find a much better/broader set of citations]
...
[TODO: make sure we are citing the right people]
...
\begin{figure}[t]
  ...
  \caption{[TODO: need three steps: tensor factorization, optimize composite likelihood, recover model parameters; Overview of approach}
\end{figure}
...
Finally, our approach gracefully extends to more general model families
  ...
  EM.  We show that empirically, using such constraints alleviates local
  optima issues.
