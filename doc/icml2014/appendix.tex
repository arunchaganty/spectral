...
\end{align}
  ...
  Finally, using \equationref{lhood-hess}, and noting that at the true parameters $\tilde M_\sV = M_\sV$, 
  \begin{align*}
    \Sigma_{\tilde Z_\sC} 
...
\todo{How do we compare $\Sigma^\mom$ with this? Should I consider a projection?}

\todo{Argue that the asymptotic variance is finite.}
