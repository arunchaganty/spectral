...
% Sectioning
% Section macros
\providecommand{\sectionref}[1] {\hyperref[sec:#1]{Section \ref{sec:#1}}}
\providecommand{\appendixref}[1] {\hyperref[app:#1]{Appendix \ref{app:#1}}}
\providecommand{\algorithmref}[1] {\hyperref[algo:#1]{Algorithm \ref{algo:#1}}}
\providecommand{\equationref}[1] {\hyperref[eqn:#1]{Equation \eqref{eqn:#1}}}
\providecommand{\figureref}[1] {\hyperref[fig:#1]{Figure \ref{fig:#1}}}
\providecommand{\tableref}[1] {\hyperref[tbl:#1]{Table \ref{tbl:#1}}}
