...
public class HungarianAlgorithm {
	...
	protected static double findLargest		//Finds the largest element in a positive array.
	(double[][] array)
	...
	protected static double[][] transpose		//Transposes a double[][] array.
	(double[][] array)	
	{
	...
	protected static int[][] transpose		//Transposes a double[][] array.
	(int[][] array)	
	{
	...
	protected static double[][] copyOf			//Copies all elements of an array to a new array.
	(double[][] original)	
	{
	...
	protected static int[][] hgAlgorithm (double[][] array, String sumType)
	{
	...
	protected static int hg_step1(int step, double[][] cost)
	{
		//What STEP 1 does:
	...
	protected static int hg_step2(int step, double[][] cost, int[][] mask, int[]rowCover, int[] colCover)
	{
		//What STEP 2 does:
	...
	protected static int hg_step3(int step, int[][] mask, int[] colCover)
	{
		//What STEP 3 does:
	...
	protected static int hg_step4(int step, double[][] cost, int[][] mask, int[] rowCover, int[] colCover, int[] zero_RC)
	{
		//What STEP 4 does:
	...
	protected static int[] findUncoveredZero	//Aux 1 for hg_step4.
	...
	protected static int hg_step5(int step, int[][] mask, int[] rowCover, int[] colCover, int[] zero_RC)
	{
		//What STEP 5 does:	
	...
	protected static int findStarInCol			//Aux 1 for hg_step5.
	(int[][] mask, int col)
	{
	...
	protected static int findPrimeInRow		//Aux 2 for hg_step5.
	(int[][] mask, int row)
	{
		int c = -1;
	...
	protected static void convertPath			//Aux 3 for hg_step5.
	...
	protected static void erasePrimes			//Aux 4 for hg_step5.
	(int[][] mask)
	{
		for (int i=0; i<mask.length; i++)
		{
	...
	protected static void clearCovers			//Aux 5 for hg_step5 (and not only).
	...
	protected static int hg_step6(int step, double[][] cost, int[] rowCover, int[] colCover, double maxCost)
	{
		//What STEP 6 does:
	...
	protected static double findSmallest		//Aux 1 for hg_step6.
	...
	public static int[][] findWeightedMatching( double[][] weights, boolean isMax ) {
		boolean wasTransposed = false;
		if (weights.length > weights[0].length) {
			wasTransposed = true;
			// Array transposed (because rows>columns)
			weights = transpose(weights);
		}
		String sumType = isMax ? "max" : "min";
		int[][] assignment = hgAlgorithm(weights, sumType);	//Call Hungarian algorithm.
		
		if( wasTransposed ) 
			assignment = transpose(assignment);
