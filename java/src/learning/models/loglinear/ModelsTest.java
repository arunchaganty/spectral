...
public class ModelsTest {
  ...
  public void testMixture() {
    ...
    {
      Params params = model.newParams();
      params.set(new UnaryFeature(0,"x="+0), Math.log(2.0));
      params.set(new UnaryFeature(0,"x="+1), Math.log(3.0));
      params.set(new UnaryFeature(1,"x="+0), Math.log(3.0));
      params.set(new UnaryFeature(1,"x="+1), Math.log(2.0));
      Params counts = model.getMarginals(params);
...
//      Assert.assertEquals(counts.get(new UnaryFeature(0,"x="+0)), 0.25 * 8, 1e-3 );
//      Assert.assertEquals(counts.get(new UnaryFeature(0,"x="+1)), 0.25 * 8, 1e-3 );
//      Assert.assertEquals(counts.get(new UnaryFeature(1,"x="+0)), 0.25 * 8, 1e-3 );
//      Assert.assertEquals(counts.get(new UnaryFeature(1,"x="+1)), 0.25 * 8, 1e-3 );
//
//      Assert.assertEquals(counts.get(new BinaryFeature(0,0)), 0.25 * 4, 1e-3);
//      Assert.assertEquals(counts.get(new BinaryFeature(0,1)), 0.25 * 4, 1e-3);
//      Assert.assertEquals(counts.get(new BinaryFeature(1,0)), 0.25 * 4, 1e-3);
//      Assert.assertEquals(counts.get(new BinaryFeature(1,1)), 0.25 * 4, 1e-3);
    }
    {
      Params counts = model.getMarginals(params1);
      LogInfo.log(counts);
