 ...
 */
public class HiddenMarkovModelOld implements EMOptimizable, Serializable, HasExactMoments, HasSampleMoments {
  /**
...
//  }
  ...
  public HiddenMarkovModelOld( Params p ) {
    this.params = p;
  }
  public HiddenMarkovModelOld( int stateCount, int emissionCount ) {
		params = new Params( stateCount, emissionCount );
  }

  public static HiddenMarkovModelOld generate( GenerationOptions options ) {
		Params params = Params.uniformWithNoise( options.paramRandom, options.stateCount, options.emissionCount, options.noise );
    return new HiddenMarkovModelOld( params );
  }
  ...
  public double likelihood(int[][] data) {
	...
	public static HiddenMarkovModelOld learnFullyObserved( int stateCount, int emissionCount, int[][] X, int[][] Z,
			boolean shouldSmooth) {
		Params p = Params.fromCounts( stateCount, emissionCount, X, Z, shouldSmooth);

		return new HiddenMarkovModelOld(p);
	}
	...
	public static HiddenMarkovModelOld learnFullyObserved( int stateCount, int emissionCount, int[][] X, int[][] Z,
		...
		return new HiddenMarkovModelOld(p_);
	}
