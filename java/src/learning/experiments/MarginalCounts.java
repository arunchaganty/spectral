...
//    params1.set(UndirectedHiddenMarkovModel.oFeature(0, 0), Math.log(1.));
//    params1.set(UndirectedHiddenMarkovModel.oFeature(0, 1), Math.log(1.));
//    params1.set(UndirectedHiddenMarkovModel.oFeature(1, 0), Math.log(1.));
//    params1.set(UndirectedHiddenMarkovModel.oFeature(1, 1), Math.log(1.));
//
...
//
////    params1.set(UndirectedHiddenMarkovModel.oFeature(0, 0), 0.4549482263236486);
////    params1.set(UndirectedHiddenMarkovModel.oFeature(0, 1), 0.7055357649634446);
////    params1.set(UndirectedHiddenMarkovModel.oFeature(1, 0), -0.9284808331570149);
////    params1.set(UndirectedHiddenMarkovModel.oFeature(1, 1), 0.15254212472490214);
////
...
//    params2.set(UndirectedHiddenMarkovModel.oFeature(0, 0), Math.log(4.));
//    params2.set(UndirectedHiddenMarkovModel.oFeature(0, 1), Math.log(1.));
//    params2.set(UndirectedHiddenMarkovModel.oFeature(1, 0), Math.log(1.));
//    params2.set(UndirectedHiddenMarkovModel.oFeature(1, 1), Math.log(4.));
//
...
////
////    params2.set(UndirectedHiddenMarkovModel.oFeature(0, 0), 0.6939332743963367);
////    params2.set(UndirectedHiddenMarkovModel.oFeature(0, 1), 0.6391140014026073);
////    params2.set(UndirectedHiddenMarkovModel.oFeature(1, 0), -0.665006807009526);
////    params2.set(UndirectedHiddenMarkovModel.oFeature(1, 1), 0.7482242232940524);
////
